...
const BarcodeScanner = lazy(() => import("react-barcode-scanner").then(module => ({ default: module.BarcodeScanner })));
...
export const RecordResults = () => {
    ...
    return (
        <>
            ...
            <Box sx={{ padding: 2 }}>
                <Box sx={{height: "50vh"}}>
                    <Suspense fallback={<Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100%' }}><Typography>Loading Scanner...</Typography></Box>}>
                    <BarcodeScanner
                        onCapture={(barcodes) => {
                ...
                {scannedData && (
                    ...
                    >
                        ...
                        <Typography variant="h3" sx={{ color: "white", marginTop: 2 }}>
                            {scannedData} finished #{number - 1}! Congratulations!
                        </Typography>
                    </Box>
                )}
                <Toaster 
